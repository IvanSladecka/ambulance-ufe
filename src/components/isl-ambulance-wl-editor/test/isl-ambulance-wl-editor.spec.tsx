...
import { IslAmbulanceWlEditor } from '../isl-ambulance-wl-editor';
...
describe('isl-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [IslAmbulanceWlEditor],
      html: `<isl-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></isl-ambulance-wl-editor>`,
    });
    await delay(300);
